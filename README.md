...
The **Unreadable** option is disabled by default, because it uses data from [JS Nice](http://www.jsnice.org/). This cannot be done with JavaScript. You need to install UserScript [jsUnpacker_helper.user.js](https://github.com/oathanrex/jsUnpacker/blob/master/userscript/jsUnpacker_helper.user.js) to enable it.

Install one of the following links:

- [Open User JS](https://openuserjs.org/scripts/baivong/jsUnpacker_helper)
- [Greasy Fork](https://greasyfork.org/vi/scripts/33479-jsUnpacker-helper)
- [Github](https://oathanrex.github.io/jsUnpacker/userscript/jsUnpacker_helper.user.js)

`*` _**jsUnpacker helper** doesn't work offline._
...
Preview **jsUnpacker** in your web browser at <http://localhost:4000/jsUnpacker/>

### Attach Shell

    docker exec -it jsUnpacker_app bash
...
### Install
    ...
    git clone https://github.com/oathanrex/jsUnpacker.git
    cd jsUnpacker
...
[MIT License](https://baivong.mit-license.org/) © [Oathan Rex](https://github.com/oathanrex)

## Credits

### Active Contributors

- [oathanrex](https://github.com/oathanrex)
